...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void frameInit()
    {
        ...
        if (this.mc.currentScreen instanceof LucidClientMainMenu)
        {
            this.updateMainMenu((LucidClientMainMenu)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(LucidClientMainMenu p_updateMainMenu_1_)
    {
        try
        {
            String s = null;
            ...
            Field[] afield = LucidClientMainMenu.class.getDeclaredFields();
