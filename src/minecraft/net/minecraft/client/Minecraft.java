...
import lucidclient.ui.LucidClientMainMenu;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        LucidClient.INSTANCE.startup();

        if (this.serverName != null)
        {
            this.displayGuiScreen(new GuiConnecting(new LucidClientMainMenu(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new LucidClientMainMenu());
        }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = new LucidClientMainMenu();
        }
        ...
        if (guiScreenIn instanceof LucidClientMainMenu)
        {
