...
public class Reflector
{
    ...
    public static ReflectorClass LucidClientMainMenu = new ReflectorClass(GuiMainMenu.class);
    public static ReflectorField GuiMainMenu_splashText = new ReflectorField(LucidClientMainMenu, String.class);
